...
class WechatController extends Controller
{
    ...
    {
        $req = $request->all();
        $source_info = DB::connection('myshop')->table('wechat_source')->where(['id'=>$req['id']])->first();
        ...
        if($source_type != 'video'){
            ...
            DB::connection('myshop')->table('wechat_source')->where(['id'=>$req['id']])->update([
...
//        dd($info);
        ...
        foreach($info['item'] as $v){
            ...
            if(empty($media_info)){
                DB::connection('myshop')->table('wechat_source')->insert([
                    'media_id'=>$v['media_id'],
        ...
        $source_info = DB::connection('myshop')->table('wechat_source')->whereIn('media_id',$media_id_list)->where(['type'=>$source_arr[$source_type]])->get();
    ...
    {
        $req = $request->all();
        $openid_info = DB::connection('myshop')->table('wechat_openid')->get();
